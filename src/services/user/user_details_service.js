...
class UserDetailService extends BaseService {
  async createUserDetail(userId, user_name, first_name, last_name, address, email, phone, user_type, age, gender) {
    return await this.create({ userId, user_name, first_name, last_name,  address, email, phone, user_type, age, gender })
  }
